          ...
          <div className="sb-acc" style={{ gridTemplateRows: collapsed || entregablesOpen ? "1fr" : "0fr" }}>
            <div className="sb-acc-inner">
              <div style={{ display: "flex", flexDirection: "column", gap: 2, padding: collapsed ? "4px 6px" : "2px 6px" }}>
                ...
                {/* Regalo de entrada: disponible para TODOS desde el arranque, sin misiones. */}
                <EntregableRow name="Manual NAICS 2022" sub="🎁 Regalo · Catálogo completo" href="/codigos-naics-2022.pdf" available collapsed={collapsed} />
